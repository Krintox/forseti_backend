...
class EventType(str, Enum):
    ...
    INTENT_FIREWALL_VERDICT = "INTENT_FIREWALL_VERDICT"
    DECEPTION_LAB_VERDICT = "DECEPTION_LAB_VERDICT"
    SETTLEMENT_RECONCILIATION_VERDICT = "SETTLEMENT_RECONCILIATION_VERDICT"
    # detection
    ML_SCORE = "ML_SCORE"
